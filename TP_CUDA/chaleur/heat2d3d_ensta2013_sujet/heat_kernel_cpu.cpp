...
////////////////////////////////////////////////////////////////////////////////
void
heat2d_ftcs_cpu_order2( real_t* data, real_t* dataNext)
{
  real_t &R  = o2.R;
  real_t &R2 = o2.R2;
  ...
  for( unsigned int j = 1; j < NY-1; ++j) 
    for( unsigned int i = 1; i < NX-1; ++i) {
      ...
      dataNext[index] = R2*data[index] + 
	R*(data[index-1] + data[index+1] + data[index-NX] + data[index+NX]);
    }
...
////////////////////////////////////////////////////////////////////////////////
void
heat2d_ftcs_cpu_order2b( real_t* data, real_t* dataNext)
{
  real_t &R   = o2.R;
  real_t &R2b = o2.R2b;
  ...
  for( unsigned int j = 1; j < NY-1; ++j) 
    for( unsigned int i = 1; i < NX-1; ++i) {
      ...
      tmp += R * ( data[index+1-NX] + data[index  -NX] + data[index-1-NX] +
...
////////////////////////////////////////////////////////////////////////////////
void
heat2d_ftcs_cpu_order4( real_t* data, real_t* dataNext)
{
  real_t &S  = o4.S;
  real_t &S2 = o4.S2;
...
////////////////////////////////////////////////////////////////////////////////
void
heat2d_ftcs_cpu_order2_with_mask( real_t* data, real_t* dataNext, int* mask)
{
  real_t &R  = o2.R;
  real_t &R2 = o2.R2;
