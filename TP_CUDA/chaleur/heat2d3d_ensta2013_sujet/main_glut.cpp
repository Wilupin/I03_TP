...
/* ============================= */
#ifdef __CUDACC__
__global__ void data_to_pixel_kernel( const float *dataIn,
...
void createPBO()
{
  ...
  glBufferDataARB(GL_PIXEL_UNPACK_BUFFER_ARB, NX*NY*4, NULL, GL_STREAM_COPY_ARB);
